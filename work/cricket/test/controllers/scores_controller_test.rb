...
class ScoresControllerTest < ActionController::TestCase
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post :create, score: { highest_score: @score.highest_score, total_score: @score.total_score, wickets: @score.wickets }
    end
  ...
  test "should update score" do
    patch :update, id: @score, score: { highest_score: @score.highest_score, total_score: @score.total_score, wickets: @score.wickets }
    assert_redirected_to score_path(assigns(:score))
  end
